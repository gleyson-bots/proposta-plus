...
export default async function WorkspaceDashboardPage() {
  ...
  return <>
    <header className="pageHeader">
      <div><p className="eyebrow">PAINEL COMERCIAL · {ROLE_LABELS[actor.role].toUpperCase()}</p><h1>Workspace Next.js</h1><p className="subtitle">Área paralela da nova arquitetura. O fluxo oficial da proposta permanece no motor original enquanto cada regra é migrada e validada.</p></div>
      <Link href="/proposta" className="button">Abrir Proposta+</Link>
    </header>
